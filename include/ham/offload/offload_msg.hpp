...
public:
	...
	void operator()() //const
	{
		...
		HAM_DEBUG( HAM_LOG << "offload_result_msg::operator()(): this = " << (void*)this << " sending result via req(" << req.target_node << ", " << req.send_buffer_index << ", " << req.source_node << ", " << req.recv_buffer_index << ")" << std::endl; )
